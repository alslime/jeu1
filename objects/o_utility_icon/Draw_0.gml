x = camera_get_view_x(view_camera[0]) + 90
y = camera_get_view_y(view_camera[0]) + camera_get_view_height(view_camera[0]) - 32 - sprite_height
...
if surface_exists(inst_front_surface.front_surf)
{
	...
	draw_text_transformed_color(x + sprite_width/2 - (string_width(string(utility_selected))/2),y+sprite_height,string(utility_selected),1,1,0,c_white,c_white,c_white,c_white,1)
