...
physics_fixture_set_collision_group(fix_r,0)physics_fixture_set_linear_damping(fix_r,0.1)
...
physics_fixture_set_collision_group(fix_l,0)physics_fixture_set_linear_damping(fix_l,0.1)
