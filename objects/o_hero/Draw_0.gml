...
if instance_exists(o_front_surface)
{
	...
	{	
		...
		draw_text_transformed_color(x1 +15, y1 + 2,string(hpmax-hplost),1,1,0,c_white,c_white,c_white,c_white,1)
		draw_text_transformed_color(x1 +15, y1 + 16,string(energymax-energylost),1,1,0,c_white,c_white,c_white,c_white,1)
